    ...
    <Grid container sx={{...sx,pb:1}}>
      ...
      >
        <defs>
          ...
          >
            <feGaussianBlur
              id="e8wE5r7vOZN8-filter-drop-shadow-0-blur"
              in="SourceAlpha"
              stdDeviation="15,15"
            />
            <feOffset
              id="e8wE5r7vOZN8-filter-drop-shadow-0-offset"
              dx="0"
              dy="0"
              result="tmp"
            />
            <feFlood
              id="e8wE5r7vOZN8-filter-drop-shadow-0-flood"
              floodColor="rgba(0,0,0,0.2)"
            />
            <feComposite
              id="e8wE5r7vOZN8-filter-drop-shadow-0-composite"
              operator="in"
              in2="tmp"
            />
            <feMerge id="e8wE5r7vOZN8-filter-drop-shadow-0-merge">
              <feMergeNode id="e8wE5r7vOZN8-filter-drop-shadow-0-merge-node-1" />
              <feMergeNode
                id="e8wE5r7vOZN8-filter-drop-shadow-0-merge-node-2"
                in="SourceGraphic"
              />
            </feMerge>
          </filter>
          <filter
            id="e8wE5r7vOZN12-filter"
            x="-150%"
            width="400%"
            y="-150%"
            height="400%"
          >
            <feGaussianBlur
              id="e8wE5r7vOZN12-filter-drop-shadow-0-blur"
              in="SourceAlpha"
              stdDeviation="10,10"
            />
            <feOffset
              id="e8wE5r7vOZN12-filter-drop-shadow-0-offset"
              dx="0"
              dy="0"
              result="tmp"
            />
            <feFlood
              id="e8wE5r7vOZN12-filter-drop-shadow-0-flood"
              floodColor="rgba(0,0,0,0.2)"
            />
            <feComposite
              id="e8wE5r7vOZN12-filter-drop-shadow-0-composite"
              operator="in"
              in2="tmp"
            />
            <feMerge id="e8wE5r7vOZN12-filter-drop-shadow-0-merge">
              <feMergeNode id="e8wE5r7vOZN12-filter-drop-shadow-0-merge-node-1" />
              <feMergeNode
                id="e8wE5r7vOZN12-filter-drop-shadow-0-merge-node-2"
                in="SourceGraphic"
              />
            </feMerge>
          </filter>
        ...
        <rect
          ...
          rx="0"
          ry="0"
          transform="matrix(1.057955-.141606 0.205693 1.536763-51.662786 483.732721)"
          fillOpacity="0.3"
          strokeWidth="0"
        />
        <rect
          ...
          rx="0"
          ry="0"
          transform="matrix(1.043083-.107576 0.156263 1.515161-41.305589 489.443024)"
          fillOpacity="0.4"
          strokeWidth="0"
        />
        <rect
          ...
          rx="0"
          ry="0"
          transform="matrix(1.038643-.064105 0.093116 1.508711-28.787654 495.617637)"
          fillOpacity="0.5"
          strokeWidth="0"
        />
        <rect
        ...
        <text
          ...
          fontSize="40"
          fontWeight="400"
          transform="translate(118.854 132.203)"
          filter="url(#e8wE5r7vOZN8-filter)"
          fill="#fffefe"
          strokeWidth="0"
        >
          <tspan
        ...
        <text
          ...
          fontSize="56"
          fontWeight="400"
          transform="translate(109.428 610.128)"
          fill="#fff"
          strokeWidth="0"
        >
        ...
        <text
          ...
          fontSize="70"
          fontWeight="400"
          transform="translate(116.19 224.068116)"
          filter="url(#e8wE5r7vOZN12-filter)"
          fill="#fff"
          strokeWidth="0"
        >
          <tspan y="0" fontWeight="400" strokeWidth="0">
