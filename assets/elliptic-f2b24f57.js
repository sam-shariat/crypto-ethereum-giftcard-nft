import { T as inherits_browserExports, r as require$$0$1, c as commonjsGlobal } from "./base.esm-570dabbe.js";
var hash$2 = {};
var utils$m = {};
...
BlockHash$4.prototype.update = function update(msg, enc) {
  ...
  if (this.pending.length >= this._delta8) {
    ...
    if (this.pending.length === 0)
      this.pending = null;
    msg = utils$l.join32(msg, 0, msg.length - r2, this.endian);
...
function Hmac(hash3, key2, enc) {
  ...
  this.inner = null;
  this.outer = null;
  this._init(utils$d.toArray(key2, enc));
}
var hmac = Hmac;
